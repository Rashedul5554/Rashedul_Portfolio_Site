...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var otherDetails = document.getElementById('other-details-container');
    ...
    // Checklist to Expenses navigation
    var nextBtn = document.getElementById('to-expenses-btn');
    var checklistSection = document.getElementById('checklist-section');
    var expensesSection = document.getElementById('expenses-section');
    if (nextBtn && checklistSection && expensesSection) {
        nextBtn.addEventListener('click', function() {
            ...
            if (dateSubmitted) {
                dateSubmitted.value = new Date().toISOString().slice(0,10);
            }
        });
    }
});
